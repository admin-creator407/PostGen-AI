    ...
    <div className="min-h-screen bg-page flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-surface border-r border-theme p-12">
        ...
        <div className="space-y-6">
          {[
            { icon: '✨', title: 'AI-Powered Generation', desc: 'Create polished LinkedIn posts in seconds with Gemini AI.' },
            { icon: '🎯', title: 'Multiple Formats', desc: 'Generate posts, rewrite drafts, or build carousel outlines.' },
            { icon: '📚', title: 'Content Library', desc: 'Save your best posts and access them anytime.' },
          ].map(({ icon, title, desc }) => (
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <p className="text-sm mb-8" style={{ color: 'var(--text-muted)' }}>
            Start generating high-performing LinkedIn content today.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <input
                id="name"
                type="text"
                className={`input-base h-11 ${errors.name ? 'input-error' : ''}`}
